...
console.log("SERVER [echo]:",server);
						...
						janus.attach(
							{
									...
									echo.createOffer(
										{
											...
											success: function(jsep) {
												Janus.debug("Got SDP!");
												Janus.debug(jsep);
												echo.send({"message": body, "jsep": jsep});
											},
								...
								onmessage: function(msg, jsep) {
									...
									if(jsep !== undefined && jsep !== null) {
										...
										Janus.debug(jsep);
										echo.handleRemoteJsep({jsep: jsep});
									}
								...
								onlocalstream: function(stream) {
									...
									if(echo.webrtcStuff.pc.iceConnectionState !== "completed" &&
											echo.webrtcStuff.pc.iceConnectionState !== "connected") {
								...
								onremotestream: function(stream) {
									...
									$('#toggleaudio').click(
										function() {
											...
											echo.send({"message": { "audio": audioenabled }});
										});
									$('#togglevideo').click(
										function() {
									...
									$('#bitrate a').click(function() {
										...
										echo.send({"message": { "bitrate": bitrate }});
										return false;
									});
